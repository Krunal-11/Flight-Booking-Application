...
CREATE TABLE `booking_travellers` (
  ...
  PRIMARY KEY (`booking_id`,`traveller_id`),
  KEY `traveller_id` (`traveller_id`),
  CONSTRAINT `booking_travellers_ibfk_1` FOREIGN KEY (`booking_id`) REFERENCES `bookings` (`booking_id`),
  CONSTRAINT `booking_travellers_ibfk_2` FOREIGN KEY (`traveller_id`) REFERENCES `travellers` (`traveller_id`)
